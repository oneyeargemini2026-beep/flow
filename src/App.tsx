...
const LoginView = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen w-screen bg-bg text-text-main">
      <div className="p-8 bg-bg2 rounded-2xl shadow-lg max-w-sm w-full text-center">
        <h1 className="text-3xl font-bold mb-2">Welcome</h1>
        <p className="text-text-muted mb-8">Sign in to sync your tasks across devices.</p>
        <button 
          onClick={signIn}
          className="w-full py-3 px-4 bg-accent text-white font-bold rounded-xl hover:bg-accent/90 transition-colors flex items-center justify-center gap-2"
        >
